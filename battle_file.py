...
def start_battler(screen, player_list, enamy_list, size):
    bg = pygame.image.load('data/battle_fon.png')
    prepared_bg = pygame.transform.scale(bg, (size))
    running = True
    FPS = 60
    ...
    global galtran, player_l, enamy_l
    galtran = Intelligence(board)
    player_l, enamy_l = player_list, enamy_list
